...
const LoginForm = () => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            if (res.data.Ec === 0) {
                ...
                // localStorage.setItem("token", res.data.payloadToken.accessToken);
    ...
    return (
        <form onSubmit={handleLogin} className="w-[max(40vw,400px)] bg-white rounded">
            ...
            <div className="w-full flex justify-center mb-5">
                <button className="w-[150px] py-2 bg-amber-100 rounded font-medium text-[20px]">Login</button>
            </div>
        </form>
    )
}
