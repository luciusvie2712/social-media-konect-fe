  ...
  return (
    <>
            ...
            {openMenu && (
              <div className="absolute top-4 right-1 bg-gray-200 rounded border-1 border-gray-300 z-1 w-[100px] flex flex-col">
                {post?.author?._id === userId ? (
                  ...
                  <span
                    className="hover:opacity-50 px- text-right mx-2"
                    onClick={() => showModalChooseReason(post._id)}
                  >
                    <i className="fa-solid fa-triangle-exclamation mx-1"></i>
                    Báo cáo
                  </span>
                )}
              </div>
      ...
      <Modal show={show} onHide={() => setShow(false)} backdrop="static">
        ...
        >
          <Modal.Title style={{ width: "100%" }}>Báo cáo</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <span style={{ fontSize: "20px", fontWeight: "500" }}>
            Lý do báo cáo bài viết ?
          </span>
