        ...
        <div className="w-full flex flex-col gap-2">
          ...
          <div className="sticky bottom-0 z-51 flex justify-end items-center gap-3 py-3 px-4 border-t border-gray-200 bg-gray-50">
            <button
              type="button"
              onClick={onClose}
              className="px-6 py-2 font-medium rounded border border-gray-300 text-gray-700 hover:bg-gray-50"
            >
              Hủy
            </button>
            <button
              ...
              disabled={isSaving}
              className="px-8 py-2 font-medium rounded bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isSaving ? (
