          ...
          <div className="w-full border-t border-gray-200 bg-gray-50 px-6 py-3">
            <div className="flex justify-end gap-2">
              <button
                onClick={onHide}
                disabled={loading}
                className="rounded-lg! px-5 py-2.5 text-sm font-medium text-gray-700 bg-white border border-gray-300 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center gap-2"
              >
              ...
              <button
                ...
                className="rounded-lg! px-5 py-2.5 text-sm font-medium text-white bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center gap-2"
              >
                {loading ? (
                  <>
