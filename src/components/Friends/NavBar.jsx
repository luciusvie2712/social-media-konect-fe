    ...
    return (
        <div className="w-[100%] h-full flex flex-col items-center">
            ...
            <div className="w-full flex flex-col items-center gap-2">
                <NavLink style={{ textDecoration: "none" }} to={`/friends/request`} className="w-full flex items-center gap-3 py-2 hover:bg-[#5b5b5b] cursor-pointer rounded px-2 text-white">
                    <i className="fa-solid fa-user-group w-4"></i>
                    <span>Lời mời kết bạn</span>
                </NavLink>
                <NavLink style={{ textDecoration: "none" }} to={`/friends/suggestion`} className="w-full flex items-center gap-3 py-2 hover:bg-[#5b5b5b] cursor-pointer rounded px-2 text-white">
